...
class Question3Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.questionText.text = "Question 3: Kì này môn nào khó nhất ?" // thay bằng câu thực tế
        binding.opt1.text = "Mobile dev"
        binding.opt2.text = "TKXDPM"
        binding.opt3.text = "ĐBCLPM"
        binding.opt4.text = "Pháp CN"
        ...
        binding.btnNext.setOnClickListener {
            ...
            if (selectedId != -1) {
                ...
                sharedVM.setAnswer(3, answer)
                findNavController().navigate(R.id.action_q3_to_result)
            } else {
